<!--login and sign up lg responsive-->
            ...
            <div class="u-header-sidebar__footer-offset">
                ...
                <div class="d-flex align-items-center position-absolute top-0 right-0 z-index-2 mt-5 mr-md-6 mr-4">
                    <button type="button" class="close ml-auto" aria-controls="sidebarContent" aria-haspopup="true"
                        ...
                        <span aria-hidden="true">Close <i class="fa fa-times ml-2"></i></span>
                    </button>
                </div>
                    ...
                    <div class="u-sidebar__content u-header-sidebar__content">
                        <form class="">
                            ...
                            <div id="login" data-target-group="idForm">
                                ...
                                <header class="border-bottom px-4 px-md-6 py-4">
                                    <h2 class="font-size-3 mb-0 d-flex align-items-center">
                                        <i class="flaticon-user mr-3 font-size-5"></i>Login
                                    </h2>
                                </header>
                                <!--username or email-->
                                <div class="p-4 p-md-6">
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="js-form-message js-focus-state">
                                            <label id="signinPasswordLabel" class="form-label" for="signinPassword">Password
                                                *</label>
                                    ...
                                    <div class="mb-4d75">
                                        <button type="submit" class="btn btn-block py-3 rounded-0 btn-dark">Log In
                                        </button>
                                    </div>
                                    <div class="mb-2">
                                        <a href="javascript:;"
                                           class="js-animation-link btn btn-block py-3 rounded-0 btn-outline-dark font-weight-medium"
                                           data-target="#signup" data-link-group="idForm" data-animation-in="fadeIn">Sign
                                            In
                                            Account</a>
                                    </div>
                                </div>
                            ...
                            <div id="forgotPassword" style="display: none; opacity: 0;" data-target-group="idForm">
                                <header class="border-bottom px-4 px-md-6 py-4">
                                    <h2 class="font-size-3 mb-0 d-flex align-items-center">
                                        <i class="flaticon-question mr-3 font-size-5"></i>Forgot Password?</h2>
                                </header>
                                <!--  email-->
                                <div class="p-4 p-md-6">
                                    <div class="form-group mb-4">
                            ...
                            <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                                <header class="border-bottom px-4 px-md-6 py-4">
                                    <h2 class="font-size-3 mb-0 d-flex align-items-center">
                                        <i class="flaticon-resume mr-3 font-size-5"></i>Create Account</h2>
                                </header>
                                <div class="p-4 p-md-6">
                                    <!--email-->
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="p-4 p-md-6">
                                        <div class="form-group mb-4">
                                            <div class="js-form-message js-focus-state">
                                                <label id="signinusrnameLabel1" class="form-label"
                                                       for="signinusrnameLabel1">username *</label>
                                                <input type="text" class="form-control rounded-0 height-4 px-4"
                                                       name="text" id="signinusrnameLabel1"
                                                       aria-describedby="signinusrnameLabel1" required>
                                            </div>
                                        </div>
