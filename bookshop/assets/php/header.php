<!--    logo and navbar and navbar toggle-->
<header id="site-header" class="site-header__v1">
    <div class="masthead border-bottom position-relative" style="margin-bottom: -1px;">
        <div class="container-fluid px-3 px-md-5 px-xl-8d75 py-2 py-md-0">
            <div class="d-flex  justify-content-between align-items-center position-relative flex-wrap">
                <!--                toggle icon-->
                <div class="offcanvas-toggler mr-4 mr-lg-8 d-xl-none">
                    ...
                    <ul class="nav">
                        <li class="nav-item">
                            <a href="index.php?page=1"
                               class="nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium active border-bottom border-primary border-width-2">
                                Home
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="authors-list.php" class="nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium">
                                Authors
                            </a>
                        </li>
                    </ul>
                </div>
                <!--                users -fav- basket icons-->
                <ul class="topbar__nav--right nav ">
                    <li class="nav-item d-none d-xl-block">
                        <a href="#" class="nav-link link-black-100">
